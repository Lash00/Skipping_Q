...
const serviceDetails = {
  ...
  post_office: {
    icon: '📮',
    details: [
      { label: 'الخدمات', value: 'إرسال الطرود، التحويلات المالية، دفع الفواتير، البريد' },
  ...
  telecom: {
    icon: '📱',
    details: [
      { label: 'الخدمات', value: 'بدل الشرائح، دفع الفواتير، ترقية الخطة، إصلاح الأجهزة' },
  ...
  traffic: {
    icon: '🚗',
    details: [
      { label: 'الخدمات', value: 'تجديد الرخص، تسجيل السيارات، دفع المخالفات، الفحص الدوري' },
  ...
  real_estate: {
    icon: '🏠',
    details: [
      { label: 'الخدمات', value: 'تسجيل العقارات، تحويل الملكية، التحقق من الملفات' },
  ...
  health_insurance: {
    icon: '💳',
    details: [
      { label: 'الخدمات', value: 'تجديد البوليصات، عضويات جديدة، تسويات الدعاوى' },
  ...
  civil_status: {
    icon: '🧾',
    details: [
      { label: 'الخدمات', value: 'شهادات الميلاد، شهادات الزواج، تعديل البيانات' },
  ...
  immigration: {
    icon: '🌍',
    details: [
      { label: 'الخدمات', value: 'تأشيرات الدخول، تجديد الإقامة، حجز المواعيد' },
...
export default function ServiceBranchDetailsScreen({ branch, serviceType, serviceName, language, darkMode }) {
        ...
        <Card darkMode={darkMode}>
          <div className="flex items-start gap-6 mb-8">
            ...
            <div className="flex-1">
              <h2 style={{ color: '#36e27b' }} className="text-2xl font-bold mb-1">
                {branch.name}
              </h2>
          ...
          >
            {details.details && details.details.map((item, idx) => (
              <div key={idx}>
                <p style={{ color: '#18472b' }} className="text-sm font-semibold mb-1">
                  {item.label}
                </p>
        ...
        <Card darkMode={darkMode}>
          ...
          <div className="space-y-4">
            <div
              ...
              className="p-4"
            >
              <p style={{ color: '#18472b' }} className="text-sm font-semibold mb-2">
                ☎️ الهاتف
              </p>
      ...
      <Card darkMode={darkMode} className="mt-6">
        ...
        >
          <div className="text-center">
            ...
            <p style={{ color: '#a8bbb3' }} className="font-semibold text-lg mb-2">
              {branch.name}
            </p>
